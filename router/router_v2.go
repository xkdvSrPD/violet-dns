...
func (r *RouterV2) Route(ctx context.Context, domain string, qtype uint16) (*dns.Msg, error) {
	startTime := time.Now()
...
// findPolicy 查找策略
func (r *RouterV2) findPolicy(groupName string) *Policy {
...
func (r *RouterV2) mergeCNAMEChain(qname string, qtype uint16, cachedAnswers []dns.RR, upstreamResp *dns.Msg) *dns.Msg {
	msg := new(dns.Msg)
...
func (r *RouterV2) handleIPValidation(ctx context.Context, domain string, qtype uint16, targetName string,
...
func (r *RouterV2) cacheResponse(ctx context.Context, domain string, resp *dns.Msg, rewriteTTL uint32) {
	// 按 qname+qtype 分组
...
// handleBlock 处理阻止策略
func (r *RouterV2) handleBlock(ctx context.Context, domain string, qtype uint16, blockType string) (*dns.Msg, error) {
	m := new(dns.Msg)
...
func (r *RouterV2) handleProxyECSFallbackV2(ctx context.Context, domain string, qtype uint16,
...
func (r *RouterV2) asyncCacheCategory(domain, category string) {
...
func (r *RouterV2) validateIPs(resp *dns.Msg, expectedIPs []string) bool {
	ips := utils.ExtractIPs(resp.Answer)
	if len(ips) == 0 {
